package com.qzx.secondhand.exception.statusCode;
...
public enum GlobalCodeEnum {
    ...
    //商品异常类 30XX
    COMMODITY_FOUNDER_ERROR(3000,"用户非商品创建者"),
    COMMODITY_NOT_EXIST(3001,"商品不存在"),
    COMMODITY_HAS_LOCKED(3002, "该物品已经被锁定"),
    EXPIRE_NOT_EXIST(3003, "不存在过期商品"),
    COLLECTION_HAS_EXIST(3050,"收藏已存在"),
    COLLECTION_NOT_EXIST(3051,"收藏不存在"),


    //求购商品异常类 31XX
    PRODUCT_FOUNDER_ERROR(3100, "用户非求购者本人"),
    PRODUCT_NOT_EXIST(3101, "求购商品不存在"),

    //消息异常类 60XX
    NOTIFICATION_SEND_ERROR(6001, "消息推送失败"),
